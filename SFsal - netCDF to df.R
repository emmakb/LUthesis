...
sss <- ncvar_get(sal_autumn_2015, "sss")
...
#Bring in variables from subset
autumn_sal_2015 <- sss[,,autumn_sub3]
##Build a data frame out of netcdf bits
...
autumn_df <- data.frame(rbind(autumn_sal_2013_df, autumn_sal_2014_df, autumn_sal_2015_df))
...
winter_rast_sal <- terra::rasterize(
  winter_vect,
  winter_mask,
  'sss' #or whatever variable name you're dealing with
)
