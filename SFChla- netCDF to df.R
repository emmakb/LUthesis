...
chla <- ncvar_get(chla_winter_2013, "chlorophyll")
...
chla <- ncvar_get(chla_winter_2014, "chlorophyll")
...
chla <- ncvar_get(chla_winter_2015, "chlorophyll")
...
chla <- ncvar_get(chla_spring_2013, "chlorophyll")
...
chla <- ncvar_get(chla_spring_2014, "chlorophyll")
...
chla <- ncvar_get(chla_spring_2015, "chlorophyll")
...
chla <- ncvar_get(chla_summer_2013, "chlorophyll")
...
chla <- ncvar_get(chla_summer_2014, "chlorophyll")
...
chla <- ncvar_get(chla_summer_2015, "chlorophyll")
...
chla <- ncvar_get(chla_autumn_2013, "chlorophyll")
...
chla <- ncvar_get(chla_autumn_2014, "chlorophyll")
...
chla <- ncvar_get(chla_autumn_2015, "chlorophyll")
...
autumn_df <- data.frame(rbind(autumn_chla_2013_df, autumn_chla_2014_df, autumn_chla_2015_df))
