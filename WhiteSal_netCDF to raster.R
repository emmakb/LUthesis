...
#Vectors of subsetted variables
winter_sst_vec_2022 <- as.vector(winter_sal_2022)
winter_sst_2022_df <- data.frame(cbind(winter_lonlattime10, winter_sal_vec_2022))
winter_sst_2022_df <- rename(winter_sal_2022_df, longitude = Var1, latitude=Var2, time=Var3, sal = winter_sal_vec_2022)
