...
save(depthWM, file = "depthWM.Rdata")
...
save(chlaWF, file = "chlaWF.Rdata")

#Link to SST data
sstWF <- rxtracto(sstInfo, parameter = "sstMasked", xcoord = xposw2, ycoord = yposw2, tcoord = tposw2, xlen = xlen, ylen = ylen)
plotTrack(sstWF, xposw2, yposw2, tposw2, plotColor = 'thermal', name = "SST")
save(sstWF, file = "sstWF.Rdata")
...
save(depthWF, file = "depthWF.Rdata")
...
save(chlaWSA, file = "chlaWSA.Rdata")
...
save(depthWSA, file = "depthWSA.Rdata")
